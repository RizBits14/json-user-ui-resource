...
const displayPost = (posts) => {
    ...
    posts.forEach((element) => {
        ...
        card.innerHTML = `
            <div class="cards space-y-4 p-6 bg-gradient-to-br from-slate-100 to-slate-200 rounded-xl shadow-lg w-full sm:w-80 mx-auto hover:translate-y-2 transition-transform duration-300 ease-in-out">
